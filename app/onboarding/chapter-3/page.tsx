...
import { ToneIcon } from '@/app/components/ToneIcon';
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <button
                      type="button"
                      onClick={() => document.getElementById('time-input')?.click()}
                      className="w-full h-14 px-5 rounded-xl border-2 border-slate-200 hover:border-amber-400 focus:border-amber-500 transition-all bg-gradient-to-br from-white to-slate-50 group-hover:shadow-lg cursor-pointer"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <p className="text-xs font-bold text-slate-500">선택된 시간</p>

...
import { SoriLogo } from '@/app/components/SoriLogo';
        ...
        <div className="relative z-10 mx-auto flex h-full min-h-screen w-full max-w-7xl flex-col px-6 sm:px-8 lg:px-12">
          ...
          <main className="flex flex-grow items-center justify-start py-12">
            <div className="flex w-full flex-col items-start justify-center gap-12">
              {/* 시작 가이드 인디케이터 */}
              <div
                className={`inline-flex items-center gap-2.5 rounded-full border border-primary/15 bg-gradient-to-r from-primary/8 to-cyan/8 px-4 py-2.5 shadow-sm backdrop-blur-sm transition-all duration-1000 ease-out ${
              ...
              <div className="flex flex-col gap-10">
                ...
                <div className="flex flex-col gap-10">
                  <p
                    className={`text-[clamp(1.05rem,2.2vw,1.65rem)] font-medium leading-[1.7] text-slate-700 transition-all delay-200 duration-700 ${
                  ...
                  {/* 소리 아이덴티티 */}
                  <div
                    className={`inline-flex items-center gap-3 self-start transition-all delay-500 duration-700 ${
                      isAnimating ? 'translate-y-4 opacity-0' : 'translate-y-0 opacity-100'
                    } ${isInitialLoad ? 'translate-y-8 opacity-0' : ''}`}
                  >

...
import { SoriLogo } from './components/SoriLogo';
import { VoiceOrb } from './components/VoiceOrb';
import { SoriCharacter } from './components/SoriCharacter';
      ...
      <div className="relative z-10 flex h-full min-h-screen flex-col">
        ...
        <main className="flex flex-1 flex-col items-center justify-center px-4 py-8 text-center">
          <div className="flex w-full max-w-5xl flex-col items-center justify-center gap-10">
            {/* 헤드라인 및 서브 카피 */}
            <div
              className={`flex flex-col items-center gap-7 transition-all duration-1000 ${
            ...
            >
              ...
              <p
                className={`text-balance max-w-4xl text-[clamp(1.05rem,2vw,1.35rem)] font-semibold leading-relaxed transition-all delay-300 duration-1000 ${
                  isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'
                }`}
                style={{
                  color: '#7c3aed',
            ...
            {/* 3D 오브젝트 - 중앙 고정 */}
            <div
              className={`relative -mt-8 flex items-center justify-center transition-all delay-500 duration-1000 ${
            ...
            {/* CTA 버튼 */}
            <div
              className={`flex flex-col items-center gap-6 transition-all delay-700 duration-1000 ${
